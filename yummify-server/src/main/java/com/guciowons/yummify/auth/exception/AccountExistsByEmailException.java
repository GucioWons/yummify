...
public class AccountExistsByEmailException extends SingleApiErrorException {
    public AccountExistsByEmailException(String location) {
        super(ApiErrorDTO.builder(ErrorMessage.KEYCLOAK_ACCOUNT_EXISTS_BY_EMAIL, HttpStatus.CONFLICT)
