...
public class DishController {
    ...
    public ResponseEntity<DishManageDTO> create(@ModelAttribute DishManageDTO dto) {
    ...
    public ResponseEntity<DishManageDTO> update(@PathVariable UUID id, @ModelAttribute DishManageDTO dto) {
        return ResponseEntity
                .status(HttpStatus.OK)
