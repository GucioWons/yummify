...
public class MenuSectionFacade {
    ...
    public MenuSection updateEntries(UUID id, UUID restaurantId, List<MenuEntrySnapshot> entrySnapshots) {
        ...
        return menuDomainExceptionHandler.handle(() -> updateMenuSectionEntriesUsecase.update(command));
    }
    ...
    public MenuSection updateName(UUID id, UUID restaurantId, Map<String, String> name) {
        ...
        return menuDomainExceptionHandler.handle(() -> updateMenuSectionNameUsecase.update(command));
    }
    ...
    public List<MenuSection> updatePosition(UUID id, UUID restaurantId, Integer position) {
        ...
        return menuDomainExceptionHandler.handle(() -> updateMenuSectionPositionUsecase.update(command));
    }
}
