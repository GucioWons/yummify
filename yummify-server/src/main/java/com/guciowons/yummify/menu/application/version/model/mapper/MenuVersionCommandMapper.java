package com.guciowons.yummify.menu.application.version.model.mapper;
...
public interface MenuVersionCommandMapper {
    ...
    GetArchivedMenuVersionQuery toGetArchivedMenuVersionQuery(UUID id, UUID restaurantId);
