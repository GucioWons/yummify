...
public class FileApplicationFixture {
    public static CreateFileCommand givenCreateFileCommand() {
        return new CreateFileCommand(givenDirectory(1), givenFileContent(1), givenRestaurantId(1));
    }

    public static DeleteFileCommand givenDeleteFileCommand() {
        return new DeleteFileCommand(givenFileId(1), givenRestaurantId(1));
    }

    public static GetFileUrlCommand givenGetFileUrlCommand() {
        return new GetFileUrlCommand(givenFileId(1), givenRestaurantId(1));
    }

    public static UpdateFileCommand givenUpdateFileCommand() {
        return new UpdateFileCommand(givenFileId(1), givenDirectory(1), givenFileContent(1), givenRestaurantId(1));
    }
