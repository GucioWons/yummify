...
class CreateMenuEntryUsecaseTest {
    ...
    private final CreateMenuEntryUsecase underTest = new CreateMenuEntryUsecase(
    ...
    void shouldCreateMenuEntry() {
        ...
        var command = givenCreateMenuEntryCommand(section.getId());
